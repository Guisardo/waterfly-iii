  ...
  Future<BillEntity> create(BillEntity entity) async {
    try {
      ...
      final BillEntityCompanion companion = BillEntityCompanion.insert(
        ...
        currencyDecimalPlaces: Value(entity.currencyDecimalPlaces),
        ...
        nextExpectedMatch: Value(entity.nextExpectedMatch),
        order: Value(entity.order),
        objectGroupOrder: Value(entity.objectGroupOrder),
        objectGroupTitle: Value(entity.objectGroupTitle),
        createdAt: now,
        updatedAt: now,
  ...
  Future<BillEntity> update(String id, BillEntity entity) async {
    try {
      ...
      final BillEntityCompanion companion = BillEntityCompanion(
        ...
        minAmount: Value(entity.minAmount),
        maxAmount: Value(entity.maxAmount),
