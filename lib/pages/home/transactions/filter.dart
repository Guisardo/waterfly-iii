...
class FilterDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    log.finest(() => "build()");
    final bool oldShowFutureTXs = context
        .read<SettingsProvider>()
        .showFutureTXs;
    final TransactionDateFilter oldTransactionDateFilter = context
        .read<SettingsProvider>()
              ...
              builder:
                  (BuildContext context, AsyncSnapshot<FilterData> snapshot) {
                    if (snapshot.hasData && snapshot.data != null) {
                      ...
                      CurrencyRead? currentCurrency =
                          currencyOptions.first.value;
                      final List<CurrencyRead> currencies =
