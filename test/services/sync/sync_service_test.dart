...
void main() {
  ...
  group('SyncService', () {
    ...
    test('sync skips when already syncing', () {
    ...
    test('validateCredentials creates auth metadata', () async {
      ...
      final SyncMetadata? authMetadata = await isar.syncMetadatas
          .filter()
          .entityTypeEqualTo('auth')
          .findFirst();
    ...
    group('sync with mocked API', () {
      ...
      test('sync accounts handles empty response', () async {
        ...
        mockApiHelper.setupAccounts(accounts: <Map<String, dynamic>>[]);
        ...
        mockApiHelper.setupCategories(
          categories: <Map<String, dynamic>>[
            <String, dynamic>{
              ...
              'links': <String, String>{
                'self': 'https://example.com/api/v1/categories/cat-1',
              },
            },
          ],
        );
      ...
      test('sync transactions handles conflict detection', () async {
        ...
        final DateTime now = DateTime.now().toUtc();
        final Map<String, dynamic> localTransactionJson = <String, dynamic>{
          'type': 'transactions',
          'id': 'tx-1',
          'attributes': <String, Object?>{
            'created_at': now.toIso8601String(),
            ...
            transactions: <Map<String, dynamic>>[
              <String, dynamic>{
                ...
                'attributes': <String, Object?>{
                  'created_at': now.toIso8601String(),
                  'updated_at': now
                      .toIso8601String(), // Same timestamp but different data
                  'group_title': null,
                  'transactions': <Map<String, Object>>[
                    <String, Object>{
                      'transaction_journal_id': 'tx-1',
      ...
      test(
        ...
        () async {
          ...
          mockApiHelper.setupAccounts(accounts: <Map<String, dynamic>>[]);
          mockApiHelper.setupCategories(categories: <Map<String, dynamic>>[]);
          mockApiHelper.setupTags(tags: <Map<String, dynamic>>[]);
          mockApiHelper.setupBills(bills: <Map<String, dynamic>>[]);
          mockApiHelper.setupBudgets(budgets: <Map<String, dynamic>>[]);
          mockApiHelper.setupCurrencies(currencies: <Map<String, dynamic>>[]);
          mockApiHelper.setupPiggyBanks(piggyBanks: <Map<String, dynamic>>[]);
          mockApiHelper.mockHttpClient.setHandler('/v1/transactions', (
            http.BaseRequest request,
          ) {
            return http.Response(
      ...
      test('sync progress stream emits updates', () async {
        ...
        syncService.progressStream?.listen((SyncProgress progress) {
                  ...
                  transactions: <Map<String, dynamic>>[
                    <String, dynamic>{
                      ...
                      'attributes': <String, Object?>{
                        'created_at': oldDate.toIso8601String(),
                        'updated_at': oldDate
                            .toIso8601String(), // Older than lastSync
                        'group_title': null,
                        'transactions': <Map<String, Object>>[
                          <String, Object>{
                            'transaction_journal_id': 'tx-1',
              ...
              MockApiResponses.budgetList(
                budgets: <Map<String, dynamic>>[
                  <String, dynamic>{
                    'type': 'budgets',
                    'id': 'budget-1',
                    'attributes': <String, String>{'name': 'Test Budget'},
                  },
                ],
              ),
            ),
          ...
          return http.Response(
            jsonEncode(
              MockApiResponses.budgetLimitList(
                budgetLimits: <Map<String, dynamic>>[
                  <String, dynamic>{
                    'type': 'budget_limits',
                    'id': 'limit-1',
                    'attributes': <String, String>{
        ...
        mockApiHelper.setupBudgets(
          budgets: <Map<String, dynamic>>[
            <String, dynamic>{
              ...
              'links': <String, String>{
                'self': 'https://example.com/api/v1/budgets/budget-1',
              },
            },
          ],
        );
        ...
        mockApiHelper.setupCurrencies(
          currencies: <Map<String, dynamic>>[
            <String, dynamic>{
              ...
              'links': <String, String>{
                'self': 'https://example.com/api/v1/currencies/1',
              },
            },
          ],
        );
      ...
      test('sync budget_limits with date range', () async {
        ...
        mockApiHelper.mockHttpClient.setHandler('/v1/budget-limits', (
          http.BaseRequest request,
        ) {
          final Uri uri = request.url;
